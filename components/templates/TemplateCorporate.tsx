...
const TemplateCorporate: React.FC<TemplateProps> = ({ cvData, personalInfo, isEditing, onDataChange, jobDescriptionForATS }) => {
  ...
  const SectionHeader: React.FC<{ title: string }> = ({ title }) => (
    <h2 className="text-lg font-semibold tracking-wide text-slate-700 mb-3">{title}</h2>
  );
    ...
    switch (key) {
      ...
      case 'skills':
        return cvData.skills.length > 0 ? (
          <section key="skills">
            <h2 className="text-lg font-semibold tracking-wide text-slate-700 mb-3">KEY SKILLS</h2>
      ...
      case 'languages':
        return cvData.languages && cvData.languages.length > 0 ? (
          <section key="languages">
            <h2 className="text-lg font-semibold tracking-wide text-slate-700 mb-3">LANGUAGES</h2>
      ...
      case 'references':
        return cvData.references && cvData.references.length > 0 ? (
          <section key="references">
            <h2 className="text-lg font-semibold tracking-wide text-slate-700 mb-3">REFERENCES</h2>
