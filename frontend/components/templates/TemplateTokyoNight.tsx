...
const TemplateTokyoNight: React.FC<TemplateProps> = ({ cvData, personalInfo, isEditing, onDataChange, jobDescriptionForATS }) => {
    ...
    const SectionHeader = ({ title }: { title: string }) => (
        <div className="flex items-center gap-3 mb-6">
            <h2 className="text-xs font-black uppercase tracking-[0.2em] px-2 py-0.5 rounded border" style={{ color: accent, backgroundColor: accent + '1a', borderColor: accent + '33' }}>{title}</h2>
