...
const TemplateSWENeon: React.FC<TemplateProps> = ({ cvData, personalInfo, isEditing, onDataChange }) => {
    ...
    return (
        ...
        <TemplateCustomSections
          ...
          renderHeader={title => <div className="flex items-center gap-3 mb-3"><h2 className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: accent }}>{title}</h2><div className="flex-1 h-px" style={{ background: accent + '26' }} /></div>}
