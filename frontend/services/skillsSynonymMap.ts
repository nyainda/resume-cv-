...
export const SKILL_SYNONYM_CLUSTERS: Array<{ canonical: string; aliases: string[] }> = [
  ...
  { canonical: 'Project Management',   aliases: ['project management', 'PM', 'program management'] },
  ...
  { canonical: 'Product Management',   aliases: ['product management', 'PM', 'Product Strategy'] },
