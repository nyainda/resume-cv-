...
12. EDUCATION IS LOCKED: return the education array exactly as received — same degree text, same school, same year, same description, word for word. Do NOT rephrase, reorder, expand, or add any keywords to education entries.
