...
9. OPENER ROTATION: Use all 7 opener types across each role — no single type may appear more than twice per role, and no more than 2 of the same type consecutively. The 7 types: (1) verb — "Manage a team of…", "Built a pipeline…"; (2) number — "KES 800K in revenue…", "3 counties served…"; (3) scope — "Across 5 regions…", "For 200+ clients…"; (4) context — "As the sole engineer…", "After acquiring 3 accounts…"; (5) timeframe — "In Q2 2024…", "Over 6 months…"; (6) collaboration — "With the operations team…", "Partnering with sales…"; (7) outcome — "Top performer in…", "Ranked #1 among…". Roles with 5+ bullets must include at least 3 different opener types.
...
12. EDUCATION — degree, school, and year are LOCKED (return them exactly as received, character for character). You MAY rewrite the description field of each education entry as one concise sentence covering thesis, relevant coursework, or honors that connects to the JD — but do NOT exaggerate, invent modules, or claim qualifications not in the source data. If no JD is provided, keep the description exactly as received.
