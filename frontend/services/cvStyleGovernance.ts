 ...
 */
export const GOVERNANCE_SUBSTITUTIONS: Array<[RegExp, string]> = [
    // ── Pure filler adverbs (safe to drop entirely) ────────────────────────
    [/\bproactively\s+/gi,                                  ''],
    [/\bseamlessly\s+/gi,                                   ''],
    [/\brobustly\s+/gi,                                     ''],
    [/\bholistically\s+/gi,                                 ''],
    ...
    // ── Filler adjective phrases (drop the modifier, keep the noun) ────────
    [/\bcutting[- ]edge\s+/gi,                              ''],
    [/\bdata[- ]driven\s+/gi,                               ''],
    [/\bworld[- ]class\s+/gi,                               ''],
    ...
    // ── Adjectives with a clear, honest synonym ────────────────────────────
    ...
    // ── AI-ism verbs (pos-preserving substitutions) ────────────────────────
    ...
    // ── Trailing filler phrases (safe to drop from end of bullets) ─────────
