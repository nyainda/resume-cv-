/**
 * Extract / generate profile from uploaded files (Gemini, Claude, Groq).
 * Extracted from geminiService — logic unchanged.
 */

import type { UserProfile } from '../types';
import { GoogleGenAI } from '@google/genai';
import { groqChat, GROQ_LARGE, getSelectedProvider, getClaudeModel } from './groqService';
...
import { parseProfileJson, _normalizeProfileIds, USER_PROFILE_SCHEMA } from './profileFromTextService';
