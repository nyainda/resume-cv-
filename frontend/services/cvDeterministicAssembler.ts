...
const FIELD_VERB_CATEGORIES: Record<CVField, string[]> = {
    ...
    frontend_web:       ['creative',      'technical',     'communication'],
    backend_eng:        ['technical',     'management',    'analysis'],
    fullstack_eng:      ['technical',     'management',    'creative'],
    mobile_eng:         ['technical',     'creative',      'management'],
    ml_ai_eng:          ['technical',     'analysis',      'management'],
    devops_infra:       ['technical',     'management',    'analysis'],
    security_eng:       ['technical',     'analysis',      'management'],
    qa_eng:             ['technical',     'analysis',      'communication'],
    product_mgmt:       ['management',    'communication', 'analysis'],
