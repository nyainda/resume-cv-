/**
 * In-memory LRU CV generation cache helpers.
 */

import { UserProfile, CVData, ScholarshipFormat } from '../../types';
...
export { invalidateCVCache, deleteCVCacheEntry };

export const CV_RULES_VERSION = '2.6'; // fit-aware narrative angles + explicit regenerate
