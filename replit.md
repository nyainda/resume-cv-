...
- **PDF Generation**: All CV downloads route through a shared service that renders the live preview DOM via headless Chrome (Playwright for dev, Cloudflare `resume-pdf-worker` for production) to ensure WYSIWYG output.
