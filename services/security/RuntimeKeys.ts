...
export function clearRuntimeKeys(): void {
    _store = { gemini: null, groq: null, cerebras: null, claude: null, tavily: null, brevo: null, jsearch: null };
}
...
/** True if at least one AI key (Groq, Cerebras, or Gemini) is loaded. */
export function hasAiKey(): boolean {
    return !!(_store.groq || _store.cerebras || _store.gemini);
}
